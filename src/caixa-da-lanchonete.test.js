...
describe('CaixaDaLanchonete', () => {
  ...
  test.each([
    ...
    ['dinheiro', 'R$ 13,30', ['cafe,1', 'combo1,1', 'chantily,1']],
    ['credito', 'R$ 14,42', ['cafe,1', 'combo1,1', 'chantily,1']],
    ['debito', 'R$ 14,00', ['cafe,1', 'combo1,1', 'chantily,1']],
  ...
  test.each([
    ...
    ['com quantidade zero', 'credito', 'Quantidade inválida!', ['suco,0']],
    ['com quantidade zero', 'debito', 'Quantidade inválida!', ['salgado,0']],
    ...
    ['com código inexistente', 'credito', 'Item inválido!', ['combo3, 1']],
    [
